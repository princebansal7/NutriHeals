...
const services: ServiceData[] = [
    ...
    monthPlan: [
      {
        ...
        sampleDayMeals: {
          earlyMorning: '1 glass warm water with juice of ½ lemon + 4 soaked almonds',
          breakfast: 'Vegetable oats upma (1 cup) + 1 boiled egg OR 1 cup low-fat curd',
          midMorning: '1 seasonal fruit (apple / guava / papaya) + 1 glass buttermilk',
          lunch: '2 multigrain rotis + 1 bowl dal + 1 bowl sabzi + salad (cucumber, tomato, onion)',
          eveningSnack: '1 handful roasted chana or makhana + 1 cup green tea',
          dinner: '1 bowl vegetable daliya khichdi OR 1 bowl moong dal soup + 1 roti + stir-fried vegetables',
          bedtime: '1 glass warm turmeric milk (low-fat)',
        },
        foodsToEat: [
      ...
      },
      {
        ...
        sampleDayMeals: {
          earlyMorning: '1 glass methi water (soaked overnight) + 5 soaked almonds + 2 walnuts',
          breakfast: '2 moong dal chilla with mint chutney + 1 cup low-fat curd',
          midMorning: '1 cup sprouts salad (chana, moong) with lemon + 1 glass coconut water',
          lunch: '1 cup brown rice + 1 bowl rajma / chole + cucumber raita + salad',
          eveningSnack: '1 cup roasted peanuts (small portion) + 1 cup green tea',
          dinner: '2 bajra rotis + 1 bowl palak paneer (low oil) + salad',
          bedtime: '1 glass warm milk (low-fat) with a pinch of cinnamon',
        },
        foodsToEat: [
      ...
      },
      {
        ...
        sampleDayMeals: {
          earlyMorning: '1 glass jeera-ajwain water (boiled, cooled) + soaked nuts',
          breakfast: 'Vegetable poha (1 cup, no potato) with peanuts + 1 glass lassi (no sugar)',
          midMorning: '1 apple or pear + 10 almonds',
          lunch: '2 jowar rotis + 1 bowl mix vegetable sabzi + 1 bowl dal + salad with olive oil dressing',
          eveningSnack: 'Roasted makhana (½ cup) + 1 cup ginger-lemon tea',
          dinner: '1 bowl vegetable soup + 1 oats dosa with vegetable stuffing',
      ...
      },
      {
        ...
        sampleDayMeals: {
          earlyMorning: 'Warm lemon water + soaked nuts',
          breakfast: '2 egg whites scrambled + 1 multigrain toast + ½ avocado OR moong chilla',
          midMorning: '1 small bowl fruit salad (papaya, apple, pomegranate)',
          lunch: '1 cup quinoa / brown rice + grilled/baked chicken or paneer + stir-fried vegetables',
          eveningSnack: 'Greek yoghurt (plain) with a few berries OR roasted chana',
          dinner: '2 rotis + 1 bowl dal + vegetable sabzi + salad',
    ...
    monthPlan: [
      {
        ...
        sampleDayMeals: {
          earlyMorning: '1 glass full-fat milk with 1 tsp honey + 5 soaked almonds + 2 walnuts + 2 dates',
          breakfast: '3 egg omelette with cheese + 2 multigrain parathas with ghee OR banana-peanut butter smoothie + poha',
          midMorning: '1 banana + 1 cup full-fat curd with 1 tbsp honey + a handful of mixed nuts',
          lunch: '1.5 cups white/brown rice + 1 bowl rajma or chole + 1 bowl paneer sabzi + salad with olive oil',
          eveningSnack: '2 slices multigrain bread with peanut butter + 1 glass full-fat milk',
          dinner: '3 rotis with ghee + 1 bowl dal makhani + 1 bowl mixed vegetables + 1 bowl curd',
          bedtime: '1 glass warm full-fat milk with 1 tsp ashwagandha powder and honey',
        },
        foodsToEat: [
      ...
      },
      {
        ...
        sampleDayMeals: {
          earlyMorning: '1 glass milk + soaked nuts + 2 dates',
          breakfast: '3 moong dal cheela stuffed with paneer + mint chutney + 1 glass lassi (sweet)',
          midMorning: '1 cup sprouts with olive oil and lemon + 1 banana',
          lunch: '2 cups rice + 1 bowl chicken curry / paneer butter masala + dal + salad',
          eveningSnack: 'Protein smoothie — 1 glass full-fat milk + 1 banana + 2 tbsp peanut butter + 1 tbsp oats',
          dinner: '3 rotis with ghee + 1 bowl dal makhani + 1 bowl vegetable curry + 1 cup curd',
          bedtime: '1 glass warm milk + 1 tsp honey + pinch of nutmeg',
        },
        foodsToEat: [
      ...
      },
      {
        ...
        sampleDayMeals: {
          earlyMorning: 'Warm milk with 1 tsp ghee + soaked figs (2) + almonds',
          breakfast: 'Besan cheela with paneer stuffing + 1 glass mango shake OR 2 eggs on avocado toast with cheese',
          midMorning: 'Banana-date-almond smoothie (1 glass) with full-fat milk',
          lunch: '2 cups rice + egg curry or paneer gravy + toor dal with ghee tadka + salad',
          eveningSnack: 'Peanut butter on 2 multigrain bread slices + 1 cup warm milk',
          dinner: '3 rotis with white butter + dal makhani + gobhi/aloo sabzi + raita',
          bedtime: '1 glass golden milk (full-fat milk + haldi + ashwagandha)',
        },
        foodsToEat: [
      ...
      },
      {
        ...
        sampleDayMeals: {
          earlyMorning: 'Warm milk + soaked nuts + 2 dates',
          breakfast: 'Paratha (2, with ghee) + curd + omelette OR banana-peanut butter milkshake + upma',
          midMorning: 'Fruit bowl (banana, mango, chikoo) + mixed nuts',
          lunch: 'Rice + dal makhani + paneer/chicken dish + vegetables + raita',
          eveningSnack: 'Homemade protein ladoo (peanuts + jaggery + sesame) + milk',
          dinner: 'Roti (3) + sabzi + dal + salad with olive oil drizzle',
          bedtime: 'Full-fat milk with ashwagandha and honey',
        },
        foodsToEat: [
  ...
  // ─── 3. PCOS / PCOD ──────────────────────────────────────────────────────
  {
    ...
    heroDescription:
      'PCOS/PCOD is one of the most common yet most mismanaged hormonal disorders. A targeted anti-inflammatory, low-GI nutrition plan can regulate your cycle, reduce symptoms, and restore hormonal balance — without harsh medications.',
    condition: {
      overview:
        'Polycystic Ovarian Syndrome (PCOS) / Polycystic Ovarian Disease (PCOD) is a hormonal disorder where the ovaries produce excess androgens (male hormones), disrupting the normal ovulation cycle and causing small cysts on the ovaries. PCOD is milder and often reversible with lifestyle changes; PCOS is a more complex metabolic syndrome. Both are deeply linked to insulin resistance and chronic inflammation.',
      symptoms: [
      ...
      causes: [
        ...
        'Genetic predisposition (mother or sister with PCOS)',
        'Endocrine-disrupting chemicals in environment or skincare',
      ],
      whoAffected:
        'PCOS/PCOD affects 1 in 5 women of reproductive age in India — approximately 20% of Indian women. It is the leading cause of female infertility. Onset typically occurs in the late teens to early 30s.',
    },
    harms: {
      overview:
        'Left unmanaged, PCOS progresses far beyond irregular periods. Its metabolic roots mean it silently increases the risk of serious long-term diseases, making early dietary intervention critical.',
      risks: [
        {
          icon: '🩸',
          title: 'Type 2 Diabetes',
          description:
            'Up to 50% of women with PCOS develop type 2 diabetes or prediabetes by age 40 due to underlying insulin resistance that worsens without dietary intervention.',
        },
        {
          icon: '❤️',
          title: 'Cardiovascular Disease',
          description:
            'PCOS raises LDL cholesterol, triglycerides, and blood pressure — significantly increasing the risk of heart attack and stroke compared to women without PCOS.',
        },
        {
          icon: '🌸',
          title: 'Infertility',
          description:
            'Chronic anovulation (failure to release eggs) prevents conception. PCOS is responsible for up to 30% of all female infertility cases in India.',
        },
        {
          icon: '🫁',
        ...
        },
        {
          ...
          description:
            'Hormonal chaos combined with weight gain, acne, and hair loss significantly increases rates of depression, anxiety, and body dysmorphia in PCOS patients.',
        },
        {
          icon: '😴',
          title: 'Sleep Apnoea',
          description:
            'Women with PCOS are 5–10× more likely to have sleep apnoea due to elevated androgens affecting airway muscle tone, compounding fatigue and insulin resistance.',
        },
      ],
    },
    nutritionBenefits: {
      overview:
        'Nutrition is the most evidence-backed first-line treatment for PCOS/PCOD. A low-GI, anti-inflammatory diet directly addresses insulin resistance — the hormonal root cause — and can restore menstrual regularity within 3 months.',
      benefits: [
        {
          icon: '🩸',
        ...
        },
        {
          ...
          description:
            'Even a 5–10% reduction in body weight in overweight PCOS patients significantly reduces androgen levels and restores hormonal balance.',
        },
        {
          icon: '🌿',
          title: 'Reduced Inflammation',
          description:
            'Omega-3 fats, antioxidants, and turmeric reduce the chronic inflammation that drives androgen excess and worsens PCOS symptoms.',
        },
        {
          icon: '✨',
    ...
    monthPlan: [
      {
        ...
        sampleDayMeals: {
          earlyMorning: '1 glass warm water + 1 tsp methi seeds (soaked overnight) OR jeera water',
          breakfast: '2 moong dal cheela with mint-coriander chutney + 1 cup low-fat curd',
          midMorning: '1 guava or apple + 5 almonds',
          lunch: '1 cup barnyard millet (sama rice) / jowar roti (2) + 1 bowl palak dal + stir-fried vegetables + cucumber raita',
          eveningSnack: '1 cup roasted chana + 1 cup green tea with cinnamon',
          dinner: '1 bowl vegetable oats soup + 2 jowar rotis + sautéed vegetables with olive oil',
          bedtime: '1 glass warm low-fat milk with ½ tsp cinnamon (cinnamon improves insulin sensitivity)',
        },
        foodsToEat: [
      ...
      },
      {
        ...
        sampleDayMeals: {
          earlyMorning: 'Warm lemon water + 5 soaked almonds + 2 walnuts',
          breakfast: 'Ragi porridge with low-fat milk, seeds, and berries OR 2 veggie-stuffed jowar rotis with curd',
          midMorning: '1 orange or kiwi (inositol-rich) + 1 tbsp flaxseed powder mixed in water',
          lunch: '1 cup quinoa or brown rice + 1 bowl mixed bean salad + 1 bowl sabzi + cucumber-tomato salad',
          eveningSnack: 'Roasted pumpkin seeds + 1 cup spearmint tea (spearmint reduces androgens)',
          dinner: '2 bajra rotis + 1 bowl palak tofu / egg bhurji + stir-fried vegetables with olive oil',
          bedtime: 'Warm chamomile tea with honey (½ tsp)',
        },
        foodsToEat: [
      ...
      },
      {
        ...
        sampleDayMeals: {
          earlyMorning: 'Warm ginger-turmeric water + walnuts',
          breakfast: 'Idli (2, ragi or standard) with sambar and coconut chutney + 1 cup homemade kanji or kefir',
          midMorning: '1 small bowl cut fruit (pomegranate, apple) + a small handful of pumpkin seeds',
          lunch: '1 cup curd rice with cucumber + 1 bowl sabzi + salad',
          eveningSnack: 'Roasted chana with lemon + spearmint/green tea',
          dinner: '2 jowar rotis + 1 bowl moong dal + stir-fried spinach + small bowl curd',
          bedtime: 'Ashwagandha warm milk (low-fat, ½ tsp ashwagandha) — reduces cortisol',
        },
        foodsToEat: [
      ...
      },
      {
        ...
        sampleDayMeals: {
          earlyMorning: 'Methi water or warm lemon water + soaked nuts',
          breakfast: '2 ragi or jowar cheela + mint chutney + curd',
          midMorning: '1 apple + 1 tbsp flaxseed in curd',
          lunch: '1.5 cups millet + 1 bowl rajma or chickpeas + vegetables + cucumber raita',
          eveningSnack: 'Spearmint tea + roasted makhana',
          dinner: '2 multigrain rotis + 1 bowl dal + palak paneer (low oil) + salad',
          bedtime: 'Chamomile or ashwagandha milk',
        },
        foodsToEat: [
          'All established PCOS-friendly foods from Weeks 1–3',
  ...
  // ─── 4. DIABETES MANAGEMENT ──────────────────────────────────────────────
  {
    ...
    condition: {
      ...
      causes: [
        ...
        'PCOS (in women) — associated insulin resistance',
      ],
      whoAffected:
    ...
    monthPlan: [
      {
        ...
        sampleDayMeals: {
          earlyMorning: '1 glass warm water with ½ tsp methi powder + 5 almonds',
          breakfast: 'Vegetable oats upma (no potato) + 1 boiled egg or low-fat curd (1 cup)',
          midMorning: '1 small apple or guava (low-GI fruits) + a small handful of walnuts',
          lunch: '2 jowar/bajra rotis + 1 bowl moong or masoor dal + 1 bowl sabzi + salad with vinegar dressing (vinegar lowers post-meal glucose)',
          eveningSnack: '1 cup roasted chana with lemon + 1 cup green/cinnamon tea',
          dinner: '1 bowl vegetable daliya or oats khichdi + 1 bowl moong soup + stir-fried greens',
          bedtime: '1 glass warm low-fat milk with ½ tsp cinnamon (optional)',
        },
        foodsToEat: [
      ...
      },
      {
        ...
        sampleDayMeals: {
          earlyMorning: 'Warm methi or karela water + soaked almonds',
          breakfast: '2 moong dal cheela with mint chutney + 1 cup low-fat curd',
          midMorning: '1 pear or 1 small guava + 5 walnuts',
          lunch: '½ cup brown rice + 1 cup mixed vegetable sabzi + 1 cup rajma or chole + salad (half plate should be salad)',
          eveningSnack: 'Roasted makhana (small bowl) + green/spearmint tea',
          dinner: '2 bajra rotis + 1 bowl spinach dal + ½ cup curd (raita)',
          bedtime: 'Warm water with ½ tsp cinnamon and a pinch of turmeric',
        },
        foodsToEat: [
      ...
      },
      {
        ...
        sampleDayMeals: {
          earlyMorning: '30 ml karela juice (fresh) OR methi water with amla juice',
          breakfast: 'Ragi or methi paratha (2, thin, minimal oil) + curd',
          midMorning: '1 cup sprouts with lemon, onion, tomato',
          lunch: '2 jowar rotis + 1 bowl mixed vegetables + 1 bowl dal + cucumber-onion salad',
          eveningSnack: '1 cup roasted chana with raw onion + chamomile or green tea',
          dinner: '1 bowl oats vegetable soup + 2 jowar rotis + 1 bowl stir-fried vegetables',
          bedtime: 'Warm low-fat milk with ½ tsp cinnamon (optional, if sugar is controlled)',
        },
        foodsToEat: [
      ...
      },
      {
        ...
        sampleDayMeals: {
          earlyMorning: 'Warm water with methi seeds or karela juice',
          breakfast: 'Vegetable oats or ragi porridge + boiled egg or moong chilla',
          midMorning: '1 fruit (apple, guava) + almonds',
          lunch: 'Millet roti (2) + dal + sabzi + large salad',
          eveningSnack: 'Roasted seeds or chana + green tea',
          dinner: 'Brown rice (small portion) + dal + palak sabzi + raita',
          bedtime: 'Warm water or plain warm milk (unsweetened)',
        },
        foodsToEat: [
    ...
    monthPlan: [
      {
        ...
        sampleDayMeals: {
          earlyMorning: '1 glass warm water + 1 tsp raw apple cider vinegar (diluted) + 5 almonds',
          breakfast: 'Vegetable oats porridge (no added salt) with seeds + 1 cup low-fat curd (unsalted)',
          midMorning: '1 banana + 5 walnuts (potassium + omega-3)',
          lunch: '2 jowar rotis (no salt in dough) + 1 bowl dal (minimal salt) + 1 bowl stir-fried vegetables + cucumber salad with lemon (no salt)',
          eveningSnack: 'Unsalted roasted chana + 1 cup hibiscus tea (proven to lower BP)',
          dinner: '1 bowl vegetable soup (low sodium homemade) + 1 jowar roti + 1 bowl sabzi',
          bedtime: '1 glass warm low-fat milk',
        },
        foodsToEat: [
      ...
      },
      {
        ...
        sampleDayMeals: {
          earlyMorning: '200 ml fresh beetroot juice or pomegranate juice (unsweetened)',
          breakfast: 'Ragi porridge with banana, seeds + 1 cup low-fat milk',
          midMorning: '1 orange + 10 unsalted almonds',
          lunch: '1 cup brown rice + 1 bowl palak dal + 1 bowl mixed vegetables + salad',
          eveningSnack: 'Roasted unsalted pumpkin seeds + 1 cup green tea',
          dinner: '2 bajra rotis + 1 bowl kidney beans (rajma, low salt) + stir-fried spinach + curd',
          bedtime: '1 glass warm low-fat milk with a pinch of nutmeg',
        },
        foodsToEat: [
      ...
      },
      {
        ...
        sampleDayMeals: {
          earlyMorning: 'Warm water with lemon + soaked walnuts (5)',
          breakfast: '2 egg whites scrambled with vegetables in olive oil + 1 multigrain roti OR methi paratha (thin, 1 tsp oil)',
          midMorning: '1 apple + 1 tbsp flaxseed powder in water or curd',
          lunch: '2 rotis + 1 bowl dal (mustard oil tadka) + sabzi + large salad with olive oil dressing',
          eveningSnack: 'Handful unsalted mixed nuts + hibiscus or chamomile tea',
          dinner: '1 bowl oat-vegetable khichdi + stir-fried greens with garlic in olive oil',
      ...
      },
      {
        ...
        sampleDayMeals: {
          earlyMorning: 'Beetroot juice or warm lemon water + nuts',
          breakfast: 'Oats upma or ragi porridge + curd',
          midMorning: 'Banana and walnuts',
          lunch: 'Millet roti + dal + vegetables + large salad',
          eveningSnack: 'Unsalted nuts + hibiscus tea',
          dinner: 'Jowar roti + rajma/palak dal + sabzi + curd',
          bedtime: 'Warm low-fat milk',
        },
        foodsToEat: [
    ...
    monthPlan: [
      {
        ...
        sampleDayMeals: {
          earlyMorning: '1 glass warm water + 5 soaked walnuts + ½ tsp turmeric in water',
          breakfast: 'Oats porridge with flaxseeds, berries, and a few almonds + 1 cup low-fat milk',
          midMorning: '1 apple + 10 unsalted almonds',
          lunch: '1.5 cups brown rice + 1 bowl chana dal (olive oil tadka) + stir-fried vegetables + tomato-onion salad',
          eveningSnack: 'Unsalted roasted seeds (pumpkin + sunflower) + 1 cup green tea',
          dinner: '2 jowar rotis + 1 bowl palak dal + stir-fried mushrooms in olive oil + curd',
          bedtime: '1 glass warm low-fat milk with ½ tsp cinnamon',
        },
        foodsToEat: [
      ...
      },
      {
        ...
        sampleDayMeals: {
          earlyMorning: 'Warm water + 5 walnuts + pinch of cinnamon',
          breakfast: '2 multigrain rotis with olive oil + 1 bowl sabzi + 1 tbsp flaxseed powder in curd',
          midMorning: '1 pomegranate or orange + unsalted almonds',
          lunch: '1 cup quinoa or brown rice + grilled/baked fish or paneer + large mixed salad with olive oil dressing + dal',
          eveningSnack: 'Dark chocolate (2 squares, ≥70%) + green tea',
          dinner: '2 bajra rotis + 1 bowl mixed bean curry + stir-fried broccoli + curd',
          bedtime: 'Warm low-fat milk with turmeric (golden milk)',
        },
        foodsToEat: [
      ...
      },
      {
        ...
        sampleDayMeals: {
          earlyMorning: 'Warm water + 1 tsp psyllium husk in a glass of water (20 min before breakfast)',
          breakfast: 'Oat-barley porridge with banana, walnuts, flaxseeds + low-fat milk',
          midMorning: 'Amla juice (30 ml fresh) OR 2 kiwis + almonds',
          lunch: '2 jowar rotis + 1 bowl chana masala + large salad + raita',
          eveningSnack: 'Steamed edamame or roasted chana + hibiscus or green tea',
          dinner: '1 bowl barley-vegetable khichdi + stir-fried beans + curd',
          bedtime: 'Warm golden milk (turmeric + ginger + low-fat milk)',
        },
        foodsToEat: [
      ...
      },
      {
        ...
        sampleDayMeals: {
          earlyMorning: 'Warm water with turmeric + walnuts',
          breakfast: 'Oats or ragi porridge with seeds and fruit',
          midMorning: 'Fresh fruit + almonds',
          lunch: 'Brown rice/millet + legumes + large salad + curd',
          eveningSnack: 'Unsalted seeds + green/hibiscus tea',
          dinner: 'Multigrain roti + palak/dal + stir-fried vegetables',
          bedtime: 'Golden milk',
        },
        foodsToEat: [
    ...
    monthPlan: [
      {
        ...
        sampleDayMeals: {
          earlyMorning: 'Small glass of water (within fluid limit) + 3–4 soaked almonds',
          breakfast: 'Plain white rice (rinsed to reduce potassium) + 1 egg white omelette (no salt) + bottle gourd sabzi',
          midMorning: 'Apple (small, peeled) — moderate potassium',
          lunch: 'White rice + 1 bowl low-potassium dal (toor or moong, drained and rinsed) + ridge gourd / pumpkin sabzi',
          eveningSnack: 'Arrowroot biscuits (low sodium/potassium) + 1 small cup white tea',
          dinner: 'Plain white roti (2, no salt in dough) + bottle gourd or lauki sabzi + egg white curry',
          bedtime: 'Small glass warm water if within fluid allowance',
        },
        foodsToEat: [
      ...
      },
      {
        ...
        sampleDayMeals: {
          earlyMorning: 'Warm water + small portion soaked almonds (3–4 only)',
          breakfast: '1 egg white omelette + 2 plain white rotis + lauki sabzi',
          midMorning: '½ apple or small pear',
          lunch: 'White rice + small portion (30g) boiled/grilled chicken or fish + low-potassium vegetables',
          eveningSnack: 'Plain arrowroot biscuit + plain white tea (no milk if fluid-restricted)',
          dinner: '2 plain rotis + 1 bowl leached low-potassium dal (very small portion) + cucumber sabzi',
          bedtime: 'Warm water within fluid limit',
        },
        foodsToEat: [
      ...
      },
      {
        ...
        sampleDayMeals: {
          ...
          breakfast: '2 plain white rotis + pumpkin sabzi (leached) + 1 egg white',
          midMorning: 'Small piece of apple or canned (in water, drained) fruit',
          lunch: 'White rice + leached ridge gourd sabzi + very small portion moong dal (drained, rinsed) + boiled egg white',
          eveningSnack: 'Plain biscuits (low sodium) + plain weak tea',
          dinner: '2 rotis + leached lauki or tinda sabzi + small portion lean chicken or fish',
          bedtime: 'Small glass warm water',
        },
        foodsToEat: [
      ...
      },
      {
        ...
        sampleDayMeals: {
          earlyMorning: 'Warm water within fluid limit',
          breakfast: 'White rice and egg white or plain roti + leached vegetable',
          midMorning: 'Low-potassium fruit (apple, pear)',
          lunch: 'White rice + low-potassium vegetables (leached) + small protein portion',
          eveningSnack: 'Plain biscuits or rice crackers',
          dinner: 'Plain roti + leached vegetable sabzi + egg white or small chicken piece',
          bedtime: 'Warm water if within fluid limit',
        },
        foodsToEat: [
    ...
    monthPlan: [
      {
        ...
        sampleDayMeals: {
          earlyMorning: '1 cup black coffee (no sugar) + 1 tsp apple cider vinegar in water OR 5 soaked almonds',
          breakfast: 'Vegetable oats upma (no potato, no sugar) + 1 boiled egg',
          midMorning: '1 apple or pear + 5 walnuts',
          lunch: '2 jowar rotis + 1 bowl moong/masoor dal + 1 bowl stir-fried vegetables + cucumber salad',
          eveningSnack: '1 cup black/green tea + roasted chana',
          dinner: '1 bowl vegetable daliya or oats khichdi + 1 bowl dal + stir-fried greens',
          bedtime: 'Warm water with turmeric and a pinch of black pepper (curcumin is hepatoprotective)',
        },
        foodsToEat: [
      ...
      },
      {
        ...
        sampleDayMeals: {
          earlyMorning: '1 cup black coffee + 5 walnuts + 4 almonds',
          breakfast: '2 moong dal cheela + mint chutney + 1 tbsp flaxseed powder in curd',
          midMorning: '1 kiwi or apple + a small handful of pumpkin seeds',
          lunch: '1 cup quinoa or brown rice + 1 bowl rajma or chickpeas + turmeric-lemon dressed salad + stir-fried broccoli',
          eveningSnack: 'Roasted sunflower and pumpkin seeds + green tea with ginger',
          dinner: '2 bajra rotis + 1 bowl fish curry (sardine/mackerel) or tofu sabzi with turmeric + stir-fried spinach',
          bedtime: 'Warm golden milk (low-fat, ½ tsp turmeric, pinch black pepper)',
        },
        foodsToEat: [
      ...
      },
      {
        ...
        sampleDayMeals: {
          earlyMorning: 'Black coffee or warm water with lemon + soaked nuts',
          breakfast: 'Oat-flaxseed porridge with berries OR 2 ragi cheela + homemade curd (probiotic)',
          midMorning: 'Apple or papaya + handful of walnuts',
          lunch: '1 cup brown rice + 1 bowl mixed dal + salad with olive oil-lemon dressing',
          eveningSnack: 'Green tea with ginger + roasted chana',
          dinner: '2 jowar rotis + 1 bowl palak dal + 1 small bowl homemade curd + cucumber',
          bedtime: 'Warm turmeric water with black pepper',
        },
        foodsToEat: [
      ...
      },
      {
        ...
        sampleDayMeals: {
          earlyMorning: 'Black coffee + soaked nuts',
          breakfast: 'Oats or ragi porridge with flaxseeds + fruit',
          midMorning: 'Low-fructose fruit + pumpkin seeds',
          lunch: 'Millets or brown rice + legumes + large salad',
          eveningSnack: 'Green tea + roasted chana or seeds',
          dinner: 'Jowar roti + dal + stir-fried greens + curd',
    ...
    monthPlan: [
      {
        ...
        sampleDayMeals: {
          earlyMorning: 'Thyroid medication (if prescribed) → wait 30–60 min → then: warm water + 5 soaked almonds',
          breakfast: 'Oats porridge with 2 Brazil nuts (selenium powerhouse) + low-fat milk (iodine)',
          midMorning: '1 apple + sunflower seeds (1 tbsp) — selenium',
          lunch: '2 jowar rotis + 1 bowl moong dal + 1 bowl stir-fried spinach + cucumber-tomato salad',
          eveningSnack: 'Roasted pumpkin seeds (zinc) + 1 cup green tea (no soy-based teas)',
          dinner: '2 rotis + 1 bowl fish curry (iodine + selenium) or paneer sabzi + stir-fried vegetables',
          bedtime: 'Warm low-fat milk (iodine source) with a pinch of cinnamon',
        },
        foodsToEat: [
      ...
      },
      {
        ...
        sampleDayMeals: {
          earlyMorning: 'Warm water with lemon + 5 walnuts + soaked almonds',
          breakfast: 'Ragi porridge OR rice flakes (poha) with vegetables + 1 boiled egg',
          midMorning: '1 orange or kiwi (vitamin C reduces TPO antibodies) + sunflower seeds',
          lunch: '1 cup rice + 1 bowl fish or chicken curry + stir-fried vegetables with turmeric + salad',
          eveningSnack: 'Roasted chana + ginger-turmeric tea',
          dinner: '2 rice rotis or jowar rotis + 1 bowl dal + palak with garlic + curd',
          bedtime: 'Warm milk (if tolerated) or chamomile tea',
        },
        foodsToEat: [
      ...
      },
      {
        ...
        sampleDayMeals: {
          earlyMorning: 'Warm jeera-ginger water + soaked nuts',
          breakfast: '2 moong dal cheela + mint chutney + 1 cup curd',
          midMorning: '1 guava or pomegranate (iron + vitamin C enhances iron absorption)',
          lunch: '2 bajra rotis + 1 bowl spinach dal (iron-rich) + sabzi with turmeric + salad with lemon',
          eveningSnack: 'Roasted pumpkin seeds + 1 cup green tea',
          dinner: '2 jowar rotis + 1 bowl chicken/egg curry or paneer + stir-fried vegetables',
          bedtime: 'Warm ashwagandha milk (low-fat) — ashwagandha shown to improve TSH levels',
        },
        foodsToEat: [
      ...
      },
      {
        ...
        sampleDayMeals: {
          earlyMorning: 'Medication → 45 min → warm lemon water + nuts',
          breakfast: 'Oats or ragi porridge with Brazil nuts and seeds',
          midMorning: 'Fresh fruit + sunflower seeds',
          lunch: 'Millet roti + dal + vegetables + salad',
          eveningSnack: 'Pumpkin seeds + green tea',
          dinner: 'Jowar roti + iron-rich dal or spinach curry + curd',
          bedtime: 'Ashwagandha warm milk or chamomile tea',
        },
        foodsToEat: [
    ...
    monthPlan: [
      {
        ...
        sampleDayMeals: {
          earlyMorning: '1 glass warm water + 5 soaked almonds + 2 walnuts (plant sterols)',
          breakfast: 'Oats porridge with 1 tbsp flaxseed + banana + low-fat milk',
          midMorning: '1 apple (pectin — soluble fibre) + 10 almonds',
          lunch: '2 jowar rotis + 1 bowl rajma or chana (soluble fibre) + stir-fried vegetables + large salad with olive oil',
          eveningSnack: '1 tsp psyllium husk in water + roasted chana',
          dinner: '2 bajra rotis + 1 bowl palak dal + stir-fried mushrooms + cucumber raita',
          bedtime: '1 glass warm low-fat milk with ½ tsp cinnamon',
        },
        foodsToEat: [
      ...
      },
      {
        ...
        sampleDayMeals: {
          earlyMorning: '1 cup black coffee or green tea + soaked walnuts (5)',
          breakfast: 'Oat-barley upma with vegetables + 1 tbsp flaxseed in low-fat curd',
          midMorning: '1 pear or pomegranate + almonds',
          lunch: '1 cup barley khichdi or brown rice + 1 bowl mixed bean curry + large salad + low-fat raita',
          eveningSnack: 'Dark chocolate (2 squares, ≥70%) + green tea (flavanols reduce LDL oxidation)',
          dinner: '2 jowar rotis + 1 bowl chana dal + stir-fried broccoli in olive oil',
          bedtime: 'Warm low-fat milk with cinnamon',
        },
        foodsToEat: [
      ...
      },
      {
        ...
        sampleDayMeals: {
          earlyMorning: 'Warm water + walnuts + apple cider vinegar (1 tsp diluted)',
          breakfast: '2 egg whites scrambled in olive oil + 1 multigrain roti OR moong dal cheela',
          midMorning: '1 guava + 1 tbsp flaxseed in water',
          lunch: '2 jowar rotis + sardines/mackerel curry or paneer sabzi + large salad with olive oil-lemon dressing',
          eveningSnack: 'Mixed unsalted nuts + green tea',
          dinner: '1 bowl oat-vegetable khichdi + stir-fried greens + low-fat curd',
          bedtime: 'Warm low-fat milk with ½ tsp cinnamon',
        },
        foodsToEat: [
      ...
      },
      {
        ...
        sampleDayMeals: {
          earlyMorning: 'Warm water + walnuts',
          breakfast: 'Oats or barley porridge with flaxseeds, walnuts, low-fat milk',
          midMorning: 'Apple or pear + almonds',
          lunch: 'Millet or brown rice + legumes + large salad + low-fat raita',
          eveningSnack: 'Green/hibiscus tea + unsalted nuts or seeds',
          dinner: 'Multigrain roti + dal + vegetables in olive oil',
          bedtime: 'Warm low-fat milk',
        },
        foodsToEat: [
    ...
    monthPlan: [
      {
        ...
        sampleDayMeals: {
          earlyMorning: 'Warm water with lemon + 5 soaked almonds + 2 walnuts',
          breakfast: '2 moong dal cheela with vegetables + 1 cup low-fat curd (protein + probiotic)',
          midMorning: '1 apple + 1 tbsp almond butter or 10 almonds',
          lunch: '2 jowar rotis + 1 bowl dal + 1 bowl sabzi + cucumber-tomato salad',
          eveningSnack: 'Roasted pumpkin seeds + 1 cup spearmint or ginger tea',
          dinner: '2 bajra rotis + 1 bowl paneer or egg bhurji + stir-fried vegetables',
          bedtime: 'Warm low-fat milk with ashwagandha (½ tsp) and nutmeg pinch (calms cortisol)',
        },
        foodsToEat: [
      ...
      },
      {
        ...
        sampleDayMeals: {
          earlyMorning: 'Warm water + 1 tbsp freshly ground flaxseeds in water (Days 1–14 of cycle)',
          breakfast: 'Avocado on ragi toast or ragi porridge + 2 boiled eggs',
          midMorning: '1 orange (vitamin C for progesterone support) + pumpkin seeds',
          lunch: '1 cup brown rice + 1 bowl chickpeas + large salad with olive oil + roasted vegetables',
          eveningSnack: 'Handful mixed nuts + chamomile or spearmint tea',
          dinner: '2 rotis + 1 bowl chicken/paneer curry with ghee + stir-fried spinach',
          bedtime: 'Ashwagandha and shatavari warm milk (hormone-balancing adaptogens)',
        },
        foodsToEat: [
      ...
      },
      {
        ...
        sampleDayMeals: {
          earlyMorning: 'Warm lemon-ginger water (liver stimulant) + soaked nuts',
          breakfast: 'Oat or ragi porridge with flaxseeds + homemade curd (probiotic)',
          midMorning: 'Beetroot-carrot juice or whole beet salad (liver detox)',
          lunch: '2 jowar rotis + 1 bowl dal + broccoli/cabbage stir-fry with garlic + salad',
          eveningSnack: 'Roasted seeds + dandelion or chamomile tea',
          dinner: '1 bowl vegetable soup + 2 bajra rotis + palak tofu/paneer + curd',
          bedtime: 'Ashwagandha milk or chamomile tea',
        },
        foodsToEat: [
      ...
      },
      {
        ...
        sampleDayMeals: {
          earlyMorning: 'Warm water or lemon water + soaked nuts',
          breakfast: 'Protein-rich breakfast (eggs, cheela, or curd) + seeds',
          midMorning: 'Fresh fruit + nuts',
          lunch: 'Millets + legumes + cruciferous vegetables + salad',
          eveningSnack: 'Spearmint or chamomile tea + seeds',
          dinner: 'Roti + dal + greens + curd',
          bedtime: 'Ashwagandha or chamomile milk',
        },
        foodsToEat: [
    ...
    monthPlan: [
      {
        ...
        sampleDayMeals: {
          earlyMorning: '1 glass room-temperature water (no lemon) OR ½ cup aloe vera juice (cooling)',
          breakfast: 'Plain oats porridge (no citrus, no spice) with banana + 1 cup low-fat milk',
          midMorning: '1 banana or melon (alkaline, soothes oesophagus)',
          lunch: '2 plain rotis (no excess chilli) + 1 bowl dal (no tomato or sour ingredients) + bottle gourd/lauki sabzi (cooling) + plain curd',
          eveningSnack: 'Roasted makhana (plain) + 1 cup warm ginger tea (small amount ginger, not excess)',
          dinner: 'Small bowl daliya or plain khichdi + 1 roti + plain sabzi (before 8 PM)',
      ...
      },
      {
        ...
        sampleDayMeals: {
          earlyMorning: '30 ml fresh aloe vera juice + warm water',
          breakfast: 'Banana-oat smoothie with low-fat milk (cold) OR plain idli with light sambar (no excess tamarind)',
          midMorning: 'Melon or papaya (digestive enzymes in papaya aid digestion)',
          lunch: '2 soft rotis + plain dal + lauki/pumpkin sabzi + plain curd',
          eveningSnack: 'Plain makhana or rice cakes + chamomile tea',
          dinner: 'Small plain khichdi + steamed vegetables + 1 cup low-fat curd (before 8 PM)',
          bedtime: 'Nothing — or a small glass warm water if very uncomfortable',
        },
        foodsToEat: [
      ...
      },
      {
        ...
        sampleDayMeals: {
          earlyMorning: 'Aloe vera juice + warm water',
          breakfast: 'Ragi or oat porridge with banana + low-fat milk',
          midMorning: 'Watermelon or musk melon',
          lunch: '1–2 rotis + moong dal + ridge gourd sabzi + plain curd',
          eveningSnack: 'Chamomile tea + plain rice cakes',
          dinner: 'Oats khichdi or plain daliya + steamed pumpkin + curd (before 7:30 PM)',
          bedtime: 'Nothing — if needed, 10 minutes of gentle walking after dinner',
        },
        foodsToEat: [
      ...
      },
      {
        ...
        sampleDayMeals: {
          earlyMorning: 'Aloe vera juice + warm water',
          breakfast: 'Oats or ragi porridge + banana',
          midMorning: 'Melon or papaya',
          lunch: 'Soft roti + plain dal + cooling vegetable sabzi + curd',
          eveningSnack: 'Makhana + chamomile or fennel tea',
          dinner: 'Small plain khichdi or daliya + steamed vegetables + curd (3 hrs before bed)',
          bedtime: 'Nothing',
        },
        foodsToEat: [
    ...
    monthPlan: [
      {
        ...
        sampleDayMeals: {
          earlyMorning: '2 glasses warm water immediately on waking + 4 soaked prunes or 2 soaked figs (overnight)',
          breakfast: 'Oats porridge with 1 tbsp flaxseeds + banana + 1 cup warm low-fat milk',
          midMorning: '1 pear (sorbitol — natural laxative) + 1 glass warm water',
          lunch: '2 multigrain rotis + 1 bowl rajma or chole (high fibre) + 1 bowl vegetables + salad + 1 cup curd',
          eveningSnack: '1 cup warm water + roasted chana + 1 kiwi (proven to relieve constipation in studies)',
          dinner: '1 bowl vegetable daliya or oats khichdi + 1 bowl dal + stir-fried greens + 1 cup curd',
          bedtime: '1 glass warm water with 1 tsp psyllium husk (isabgol) in it',
        },
        foodsToEat: [
      ...
      },
      {
        ...
        sampleDayMeals: {
          earlyMorning: '2 glasses warm water + soaked prunes',
          breakfast: 'Homemade curd rice or idli with sambar + 1 cup curd with flaxseed',
          midMorning: '1 kiwi or papaya + 1 glass buttermilk (homemade)',
          lunch: '2 rotis + 1 bowl dal + sabzi + large salad + 1 cup curd',
          eveningSnack: '1 cup homemade kanji (fermented carrot/beetroot drink) OR 1 cup lassi (no sugar)',
          dinner: '2 jowar rotis + 1 bowl palak dal + stir-fried vegetables + 1 cup curd',
          bedtime: 'Warm water with 1 tsp psyllium husk + pinch of rock salt (electrolytes)',
        },
        foodsToEat: [
      ...
      },
      {
        ...
        sampleDayMeals: {
          earlyMorning: '2 glasses warm water + juice of ½ lemon + soaked prunes or figs',
          breakfast: '1 cup black coffee (optional) + oats with flaxseed + fruit',
          midMorning: '2 kiwis or 1 bowl papaya',
          lunch: '2 multigrain rotis + 1 bowl beans or lentils + stir-fried vegetables + salad + curd',
          eveningSnack: 'Roasted chana + 1 cup warm water with a pinch of rock salt and lemon',
          dinner: '1 bowl vegetable oats porridge or daliya + stir-fried spinach + curd',
          bedtime: 'Warm water with psyllium husk',
        },
        foodsToEat: [
      ...
      },
      {
        ...
        sampleDayMeals: {
          earlyMorning: '2 glasses warm water + soaked prunes or figs',
          breakfast: 'Oats or multigrain porridge with flaxseeds + fruit',
          midMorning: 'Kiwi or papaya + buttermilk',
          lunch: 'Multigrain roti + dal + vegetable + large salad + curd',
          eveningSnack: 'Roasted chana or seeds + warm water',
          dinner: 'Daliya or khichdi + stir-fried greens + curd',
          bedtime: 'Warm water ± psyllium husk if needed',
        },
        foodsToEat: [
    ...
    monthPlan: [
      {
        ...
        sampleDayMeals: {
          earlyMorning: 'Warm water with ginger (½ inch grated) and a pinch of rock salt — carminative',
          breakfast: 'Rice flakes (poha) with vegetables (no onion this week) + coconut chutney',
          midMorning: 'Papaya (digestive enzyme papain) + 1 glass warm water',
          lunch: '1 cup plain white rice + 1 bowl moong dal (well-cooked, easy to digest) + bottle gourd sabzi + plain curd (small amount)',
          eveningSnack: '1 cup fennel seed tea + plain makhana (handful)',
          dinner: '2 plain rotis + 1 bowl moong dal soup + stir-fried zucchini or ridge gourd',
          bedtime: 'Warm water with ½ tsp ajwain (carom seeds) — most effective carminative',
        },
        foodsToEat: [
      ...
      },
      {
        ...
        sampleDayMeals: {
          earlyMorning: 'Warm ginger-ajwain water + soaked almonds (5)',
          breakfast: 'Ragi or rice idli (2–3) with light coconut or tomato chutney + small cup curd',
          midMorning: 'Kiwi (reduces gut transit time and bloating in studies) or papaya',
          lunch: '1 cup plain rice + moong dal + well-cooked carrot, beans, or zucchini + small cup curd',
          eveningSnack: 'Homemade kanji or plain lassi (small cup) + fennel tea',
          dinner: '2 rotis + 1 bowl moong dal or lentil soup + stir-fried approved vegetables',
          bedtime: 'Warm water with ajwain or fennel seeds',
        },
        foodsToEat: [
      ...
      },
      {
        ...
        sampleDayMeals: {
          earlyMorning: 'Ginger water + soaked nuts',
          breakfast: 'Test wheat: 1–2 plain rotis + curd + sabzi — monitor for 3–4 hours',
          midMorning: 'Papaya or kiwi + fennel tea',
          lunch: 'Rice + properly soaked and cooked dal + cooked vegetables + curd',
          eveningSnack: 'Plain makhana + ajwain tea',
          dinner: 'Daliya or rice + dal + vegetables',
          bedtime: 'Warm ajwain or chamomile water',
        },
        foodsToEat: [
      ...
      },
      {
        ...
        sampleDayMeals: {
          earlyMorning: 'Warm ginger water + soaked nuts',
          breakfast: 'Idli or poha or ragi cheela + curd (if tolerated)',
          midMorning: 'Kiwi or papaya + fennel tea',
          lunch: 'Rice or roti (as tolerated) + dal (soaked, cooked) + cooked vegetables + curd',
          eveningSnack: 'Makhana or roasted chana + ajwain tea',
          dinner: 'Light khichdi or dal soup + stir-fried vegetables',
          bedtime: 'Warm ajwain or chamomile water',
        },
        foodsToEat: [
    ...
    monthPlan: [
      {
        ...
        sampleDayMeals: {
          earlyMorning: '1 glass warm water with lemon + 5 soaked almonds',
          breakfast: 'Ragi porridge (ragi is naturally gluten-free) with banana + 1 boiled egg',
          midMorning: '1 apple + 10 almonds',
          lunch: '1 cup plain white rice + 1 bowl moong dal + stir-fried vegetables + plain curd',
          eveningSnack: 'Roasted chana (ensure no wheat coating) + 1 cup green tea',
          dinner: '2 jowar rotis (GF) + 1 bowl dal + sabzi + curd',
      ...
      },
      {
        ...
        sampleDayMeals: {
          earlyMorning: 'Warm water + soaked GF nuts + 2 soaked figs (iron)',
          breakfast: '2 ragi cheela (calcium-rich GF grain) + 1 boiled egg (B12) + small cup curd',
          midMorning: 'Pomegranate or amla juice (vitamin C boosts iron absorption) + walnuts',
          lunch: '1 cup rice + 1 bowl palak dal (iron + folate) + 1 bowl sabzi + curd with sesame seeds (calcium)',
          eveningSnack: 'Roasted pumpkin seeds (zinc) + GF rice cakes',
          dinner: '2 jowar rotis + 1 bowl chicken/fish or lentil curry (iron, B12) + stir-fried spinach + curd',
          bedtime: '1 glass warm full-fat milk (calcium + D) with a pinch of nutmeg',
        },
        foodsToEat: [
      ...
      },
      {
        ...
        sampleDayMeals: {
          earlyMorning: 'Warm water with a pinch of turmeric (anti-inflammatory gut healer)',
          breakfast: 'GF idli (rice + urad dal) with coconut chutney + small cup curd',
          midMorning: 'Papaya (digestive enzyme for gut recovery) + pumpkin seeds',
          lunch: '1 cup rice + 1 bowl GF dal + well-cooked vegetables + curd + salad',
          eveningSnack: 'Roasted chana or GF makhana + ginger tea',
          dinner: '2 jowar/bajra rotis + palak paneer (or palak tofu) + 1 bowl GF dal',
          bedtime: 'Warm GF milk with turmeric and a pinch of black pepper',
        },
        foodsToEat: [
      ...
      },
      {
        ...
        sampleDayMeals: {
          earlyMorning: 'Warm water with lemon + soaked nuts',
          breakfast: 'Ragi or jowar porridge/cheela + boiled egg + curd',
          midMorning: 'Fresh seasonal fruit + seeds',
          lunch: 'Rice + dal + GF vegetable sabzi + curd + salad',
          eveningSnack: 'GF roasted chana or makhana + green tea',
          dinner: 'Jowar or bajra roti + dal + GF curry + curd',
          bedtime: 'Warm GF milk or chamomile tea',
        },
        foodsToEat: [
