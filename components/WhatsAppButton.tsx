  ...
  return (
    <div className="fixed bottom-6 right-6 z-50">
      ...
      <motion.a
        ...
        whileTap={{ scale: 0.92 }}
        className="relative w-16 h-16 bg-[#25D366] rounded-full flex items-center justify-center shadow-lg hover:shadow-2xl hover:bg-[#20BD5A] transition-all duration-300"
